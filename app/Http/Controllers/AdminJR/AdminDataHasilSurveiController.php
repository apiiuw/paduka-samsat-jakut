...
class AdminDataHasilSurveiController extends Controller
{
    public function index(Request $request)
    {
        ...
        // Kirim data ke view
        return view('jasa-raharja.pages.data-hasil-survei.index', compact('dataLaporan'));
    }
    ...
    public function unduhLaporan(Request $request)
    {
        ...
        $pdf = PDF::loadView('jasa-raharja.pages.data-hasil-survei.pdf', compact('dataLaporan'));
