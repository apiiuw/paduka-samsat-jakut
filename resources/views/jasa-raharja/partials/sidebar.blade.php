<aside id="logo-sidebar" class="fixed top-0 left-0 z-50 w-64 h-screen transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700" aria-label="Sidebar">
   ...
   <div class="h-full px-3 pb-4 pt-5 overflow-y-auto bg-[#373D53]">
      <div class="flex flex-col text-left text-[#ADB7C1] border-b border-[#ADB7C1] pb-3 mb-3">
         ...
         <h3 class="text-xs">Admin Jasa Raharja Kanwil DKI Jakarta</h3>
      </div>
      <ul class="space-y-2 font-medium">
         <li>
            <a href="/jr/statistik-laporan" 
               class="flex items-center p-2 rounded-lg group
                  {{ request()->is('jr/statistik-laporan') ? 'text-white bg-blueJR' : 'text-[#ADB7C1] hover:text-white hover:bg-blueJRdark' }}">
               ...
               <span class="ms-3">Statistik Laporan</span>
            </a>
         </li>
         <li>
            <a href="/jr/data-laporan" 
               class="flex items-center p-2 rounded-lg group
                  {{ request()->is('jr/data-laporan') ? 'text-white bg-blueJR' : 'text-[#ADB7C1] hover:text-white hover:bg-blueJRdark' }}">
         ...
         <li>
            <a href="/jr/data-hasil-survei" 
               class="flex items-center p-2 rounded-lg group
                  {{ request()->is('jr/data-hasil-survei') ? 'text-white bg-blueJR' : 'text-[#ADB7C1] hover:text-white hover:bg-blueJRdark' }}">
