...
<div class="p-4 sm:ml-64 bg-[#ECF3F7] min-h-screen">
   <div class="p-4 mt-24">
      ...
      <div class="mx-auto bg-white p-6 rounded-xl shadow-md mt-8">
         <h2 class="text-lg font-semibold mb-4 text-[#373A3C]">Data Hasil Survei</h2>
         ...
         <table class="min-w-[1500px] border text-sm text-left">
            <thead class="bg-[#373D53] text-white text-center">
               <tr>
                  ...
                  <th class="border px-2 py-1">Catatan Hasil Survei</th>
               </tr>
            </thead>
            <tbody class="bg-white">
               <tr class="border-t text-center">
                  ...
                  <td class="border px-2 py-1 font-semibold">Diambil Pemilik</td>
               </tr>
               <tr class="border-t text-center">
                  ...
                  <td class="border px-2 py-1 font-semibold">Data Sedang Diurus Untuk Penghapusan</td>
               </tr>
            </tbody>
         </table>
         </div>
