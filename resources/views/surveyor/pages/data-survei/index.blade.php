...
<div class="p-4 sm:ml-64 bg-[#ECF3F7] min-h-screen">
   <div class="p-4 mt-24">
      ...
      <div class="bg-white p-4 rounded-xl shadow-md">
         <p class="font-semibold text-lg text-[#373A3C]">Filter Data Wajib Survei</p>
      ...
      <div class="mx-auto bg-white p-6 rounded-xl shadow-md mt-8">
         <h2 class="text-lg font-semibold mb-4 text-[#373A3C]">Data Wajib Survei</h2>
         ...
         <table class="min-w-[1500px] border text-sm text-left">
            <thead class="bg-[#373D53] text-white text-center">
               <tr>
                  ...
                  <th class="border px-2 py-1">Input Survei</th>
               </tr>
            </thead>
               ...
               <tr class="border-t text-center">
                  ...
                  <td class="border px-2 py-1">
                     <div class="flex justify-center items-center">
                        <button class="flex justify-center bg-blueJR hover:bg-blueJRdark rounded-md py-1 px-2 text-white">Input Hasil Survei</button>
                     </div>
                  </td>
               </tr>
               <tr class="border-t text-center">
