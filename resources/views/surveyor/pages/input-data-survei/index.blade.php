...
<div class="p-4 sm:ml-64 bg-[#ECF3F7]">
   ...
   <div class="bg-white shadow rounded-lg p-6 text-sm">
      <h2 class="text-lg font-semibold mb-4 text-[#373A3C]"><span><i class="fa-solid fa-square-plus fa-lg mr-2"></i></span>Input Data Hasil Survei</h2>
      ...
      <form class="space-y-4">
         ...
         <div>
         <label class="block text-sm font-medium">Keterangan Hasil Survei</label>
         <textarea placeholder="Ketikkan Keterangan Hasil Survei..." class="mt-1 text-sm w-full border border-gray-300 rounded px-3 py-2"></textarea>
         </div>
