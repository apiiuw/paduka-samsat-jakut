         ...
         <table class="min-w-[1500px] border text-sm text-left">
            <thead class="bg-[#373D53] text-white text-center">
               <tr>
                  ...
                  <th class="border px-2 py-1">Hasil Survei</th>
               </tr>
            </thead>
            <tbody class="bg-white">
               <tr class="border-t text-center">
                  ...
                  <td class="border px-2 py-1">Data Kendaraan Sedang Diurus Untuk Penghapusan</td>
               </tr>
               <tr class="border-t text-center">
                  ...
                  <td class="border px-2 py-1">Data Kendaraan Akan Diambil Pemilik</td>
               </tr>
            </tbody>
         </table>
         </div>
